                ...
                <div class="col-md-8 col-lg-6 col-xl-5">
                    <div class="card">
                        <div class="card-body p-4">                            
                            ...
                            <form action="{{asset('/createUser')}}" method="POST" class="pt-2">
                            	{{ csrf_field() }}
                            ...
                            <div class="row mt-3">
                                <div class="col-12 text-center">
                                    <p class="text-muted mb-0">Already have account?  <a href="{{ asset('login') }}" class="text-dark ml-1"><b>Sign In</b></a></p>
                                </div> <!-- end col -->
                            </div>
                            <!-- end row -->
                        </div> <!-- end card-body -->
